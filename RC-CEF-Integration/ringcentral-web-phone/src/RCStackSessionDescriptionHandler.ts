...
import * as rcStack from "./rcs/src/index";
...
export class RCStackSessionDescriptionHandler extends EventEmitter implements WebSessionDescriptionHandler {
    /**
    ...
    public static defaultFactory(
        ...
        options: any
    ): RCStackSessionDescriptionHandler {
        const logger: Logger = session.ua.getLogger('sip.invitecontext.rcStacksessionDescriptionHandler', session.id);
        const observer: SessionDescriptionHandlerObserver = new SessionDescriptionHandlerObserver(session, options);
        return new RCStackSessionDescriptionHandler(logger, observer, options);
    }
    ...
    constructor(logger: Logger, observer: SessionDescriptionHandlerObserver, options: any) {
        ...
        this.logger.log('DEfault SessionDescriptionHandlerOptions: ' + JSON.stringify(this.options));
    ...
    private initPeerConnection(options: any = {}): void {
        ...
        console.error(' RCSTACK IS ', rcStack)
